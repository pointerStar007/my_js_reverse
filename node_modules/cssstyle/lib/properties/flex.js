...
var shorthand_for = {
  'flex-grow': require('cssstyle/lib/properties/flexGrow'),
  'flex-shrink': require('cssstyle/lib/properties/flexShrink'),
  'flex-basis': require('cssstyle/lib/properties/flexBasis'),
};
