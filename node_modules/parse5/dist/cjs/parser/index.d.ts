import { Tokenizer, TokenizerMode, type TokenHandler } from 'parse5/dist/cjs/tokenizer';
import { OpenElementStack, type StackHandler } from 'parse5/dist/cjs/parser/open-element-stack.js';
import { FormattingElementList } from 'parse5/dist/cjs/parser/formatting-element-list.js';
import { ERR, type ParserErrorHandler } from 'parse5/dist/cjs/common/error-codes.js';
import { TAG_ID as $, NS } from 'parse5/dist/cjs/common/html.js';
import type { TreeAdapter, TreeAdapterTypeMap } from 'parse5/dist/cjs/tree-adapters/interface.js';
import { type Token, type CommentToken, type CharacterToken, type TagToken, type DoctypeToken, type EOFToken, type LocationWithAttributes } from 'parse5/dist/cjs/common/token.js';
